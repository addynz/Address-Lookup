...
function AddyUrlSettingFactory(e) { function s(e) { e = e.replace(/[\[\]]/g, "\\$&"); var s = new RegExp("[?&]" + e + "(=([^&#]*)|&|#|$)").exec(i); return s ? s[2] ? decodeURIComponent(s[2].replace(/\+/g, " ")) : "" : null } this.createOptions = function () { var e = {}; return e.excludePostBox = s("excludePostBox") || !1, e.nzCountryValue = s("nzCountryValue") || "NZL", e.maxItems = s("maxItems") || 10, e }, this.getKey = function () { var e = s("key"); return e && "" != e || console.warn("The API key is missing"), e }, this.createCallback = function () { var e = s("callback"); return e && "function" == typeof window[e] ? e : null }; var i = function () { var s = document.getElementsByTagName("script"); e = e.toLowerCase(); for (var i = 0; i < s.length; i++) if (s[i].src && -1 !== s[i].src.toLowerCase().indexOf(e)) return s[i].src; return console.warn("Script source not found. Name: ", e), "" }() } function AddyComplete(e, s) { function i(e, s) { reqwest({ url: n.urlBase + e, type: "jsonp", success: function (e) { s(e) } }) } if (e) { var n = this; n.urlBase = "https://www.addy.co.nz/", n.fields = s || {}, n.options = addySettingsFactory.createOptions(), n.key = addySettingsFactory.getKey(); var t = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e) { var s = 16 * Math.random() | 0; return ("x" == e ? s : 3 & s | 8).toString(16) }); n.widget = new NeatComplete.Widget(e, { empty_content: "<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.", max_results: n.options.maxItems }); var d = null; n.widget.addService("addy", function (e, s) { n.fields.country && n.fields.country.options[n.fields.country.selectedIndex].value !== n.options.nzCountryValue || i("api/search?key=" + n.key + "&session=" + t + "&expostbox=" + n.options.excludePostBox + "&max=" + n.options.maxItems + "&s=" + e, function (i) { n.widget.setOption("max_results", n.options.maxItems), d = new RegExp("(" + e.split(" ").join("|") + ")", "gi"); for (var t = new Array, a = 0; a < i.addresses.length; a++) t.push({ value: i.addresses[a].a, data: i.addresses[a] }); s(e, t) }) }, { renderer: function (e, s) { var i = n.widget.getOption("highlight_class"); return s.a.replace(d, '<span class="' + (void 0 === i ? "nc_highlight" : i) + '">$1</span>') } }), n.widget.on("result:select", function (e, s) { i("api/address/" + s.id + "?key=" + n.key + "&session=" + t, function (e) { n.fields.address && (n.fields.address.value = e.displayline), n.fields.suburb && (n.fields.suburb.value = e.suburb), n.fields.city && (n.fields.city.value = e.city), n.fields.postcode && (n.fields.postcode.value = e.postcode), n.fields.line1 && (n.fields.line1.value = e.address1), n.fields.line2 && (n.fields.line2.value = e.address2), n.fields.line3 && (n.fields.line3.value = e.address3), n.fields.line4 && (n.fields.line4.value = e.address4), !n.fields.city && n.fields.suburb && "" === e.suburb && "" !== e.city && (n.fields.suburb.value = e.city), n.fields.address1 && n.fields.address2 ? e.address4 || 0 === e.address2.indexOf("RD ") ? (n.fields.address1.value = e.address1, n.fields.address2.value = e.address2) : (n.fields.address1.value = e.displayline, n.fields.address2.value = "") : n.fields.address1 && !n.fields.address2 && (n.fields.address1.value = e.displayline); var s = n.fields.region; if (s) if (s.options) { e.region = e.region.toUpperCase(); var i = [e.region, e.region.replace("'", ""), e.region.replace("-", " - "), e.region.replace("-", " / "), e.region.replace("-", "/")]; console.log(i); for (var t = 0; t < s.options.length; t++) if (i.indexOf(s.options[t].text.toUpperCase()) > -1 || i.indexOf(s.options[t].value.toUpperCase()) > -1) { s.selectedIndex = t; break } } else s.value = e.region }.bind(this)) }) } else console.warn("Input field is missing") } var addySettingsFactory = new AddyUrlSettingFactory("addycomplete"), addyInitCallback = addySettingsFactory.createCallback(); addyInitCallback && window[addyInitCallback]();