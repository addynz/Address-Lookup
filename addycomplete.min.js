...
function AddyUrlSettingFactory(e){function s(e){e=e.replace(/[\[\]]/g,"\\$&");var s=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(d);return s?s[2]?decodeURIComponent(s[2].replace(/\+/g," ")):"":null}this.createOptions=function(){var e={};return e.excludePostBox=s("excludePostBox")||!1,e.maxItems=s("maxItems")||10,e},this.getKey=function(){var e=s("key");return e&&""==e&&console.warn("The API key is missing"),e},this.createCallback=function(){var e=s("callback");return e&&"function"==typeof window[e]?e:null};var d=function(){var s=document.getElementsByTagName("script");e=e.toLowerCase();for(var d=0;d<s.length;d++)if(s[d].src&&-1!==s[d].src.toLowerCase().indexOf(e))return s[d].src;return console.warn("Script source not found. Name: ",e),""}()}var addySettingsFactory=new AddyUrlSettingFactory("addycomplete");function AddyComplete(e,s){if(e){var d=this;d.urlBase="https://www.addy.co.nz/",d.fields=s||{},d.options=addySettingsFactory.createOptions(),d.key=addySettingsFactory.getKey();var i="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var s=16*Math.random()|0;return("x"==e?s:3&s|8).toString(16)});d.widget=new NeatComplete.Widget(e,{empty_content:"<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.",max_results:d.options.maxItems});var t=null;d.widget.addService("addy",function(e,s){if(e.length<3)return s(e,new Array),void d.widget._hideResults();a("api/search?key="+d.key+"&session="+i+"&expostbox="+d.options.excludePostBox+"&max="+d.widget.getOption("max_results")+"&s="+e,function(d){t=new RegExp("("+e.split(" ").join("|")+")","gi");var i=new Array;if(d)for(var a=0;a<d.addresses.length;a++)i.push({value:d.addresses[a].a,data:d.addresses[a]});s(e,i)})},{renderer:function(e,s){var i=d.widget.getOption("highlight_class");return s.a.replace(t,'<span class="'+(void 0===i?"nc_highlight":i)+'">$1</span>')}}),d.setOption=function(e,s){e&&"exclude_postbox"===e?d.options.excludePostBox=s:d.widget.setOption(e,s)},d.enable=function(){d.widget.enable()},d.disable=function(){d.widget.disable()},d.addressSelected=function(e){},d.widget.on("result:select",function(e,s){a("api/address/"+s.id+"?key="+d.key+"&session="+i,function(e){if(e){d.fields.address&&(d.fields.address.value=e.displayline),d.fields.suburb&&(d.fields.suburb.value=e.suburb),d.fields.city&&(d.fields.city.value=e.city),d.fields.territory&&(d.fields.territory.value=e.territory),d.fields.x&&(d.fields.x.value=e.x),d.fields.y&&(d.fields.y.value=e.y),d.fields.dpid&&(d.fields.dpid.value=e.dpid),d.fields.id&&(d.fields.id.value=e.id),d.fields.postcode&&(d.fields.postcode.value=e.postcode),d.fields.line1&&(d.fields.line1.value=e.address1),d.fields.line2&&(d.fields.line2.value=e.address2),d.fields.line3&&(d.fields.line3.value=e.address3),d.fields.line4&&(d.fields.line4.value=e.address4),!d.fields.city&&d.fields.suburb&&""===e.suburb&&""!==e.city&&(d.fields.suburb.value=e.city),d.fields.address1&&d.fields.address2?(e.address4||0===e.address2.indexOf("RD ")?(d.fields.address1.value=e.address1,d.fields.address2.value=e.address2):(d.fields.address1.value=e.displayline,d.fields.address2.value=""),!d.fields.suburb&&e.suburb&&""!==e.suburb&&(""!==d.fields.address2.value&&(d.fields.address1.value+=", "+d.fields.address2.value),d.fields.address2.value=e.suburb)):d.fields.address1&&!d.fields.address2&&(d.fields.address1.value=e.displayline);var s=d.fields.region;if(s)if(s.options){e.region=e.region.toUpperCase();var i=[e.region,e.region.replace("'",""),e.region.replace("-"," - "),e.region.replace("-"," / "),e.region.replace("-","/")];console.log(i);for(var t=0;t<s.options.length;t++)if(i.indexOf(s.options[t].text.toUpperCase())>-1||i.indexOf(s.options[t].value.toUpperCase())>-1){s.selectedIndex=t;break}}else s.value=e.region;d.addressSelected(e)}}.bind(this))}),"demo-api-key"===d.key.toLowerCase()&&d.setOption("footer_content",'<b>Demo Mode:</b> Create a free account at <a href="https://www.addy.co.nz/" class="link-active">addy.co.nz</a>')}else console.warn("Input field is missing");function a(e,s){reqwest({url:d.urlBase+e,type:"jsonp",success:function(e){s(e)},error:function(e){console.log("Request failed",e)}})}}var addyInitCallback=addySettingsFactory.createCallback();addyInitCallback?window[addyInitCallback]():"function"==typeof initAddy&&initAddy();