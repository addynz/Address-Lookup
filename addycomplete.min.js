...
function AddyUrlSettingFactory(e) { function s(e) { e = e.replace(/[\[\]]/g, "\\$&"); var s = new RegExp("[?&]" + e + "(=([^&#]*)|&|#|$)").exec(t); return s ? s[2] ? decodeURIComponent(s[2].replace(/\+/g, " ")) : "" : null } this.createOptions = function () { var e = {}; return e.excludePostBox = s("excludePostBox") || !1, e.nzCountryValue = s("nzCountryValue") || "NZL", e.maxItems = s("maxItems") || 10, e }, this.getKey = function () { var e = s("key"); return e && "" != e || console.warn("The API key is missing"), e }, this.createCallback = function () { var e = s("callback"); return e && "function" == typeof window[e] ? e : null }; var t = function () { var s = document.getElementsByTagName("script"); e = e.toLowerCase(); for (var t = 0; t < s.length; t++) if (s[t].src && -1 !== s[t].src.toLowerCase().indexOf(e)) return s[t].src; return console.warn("Script source not found. Name: ", e), "" }() } function AddyComplete(e, s) { function t(e, s) { reqwest({ url: d.urlBase + e, type: "jsonp", success: function (e) { s(e) } }) } if (e) { var d = this; d.urlBase = "https://www.addy.co.nz/", d.fields = s || {}, d.options = addySettingsFactory.createOptions(), d.key = addySettingsFactory.getKey(); var i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e) { var s = 16 * Math.random() | 0; return ("x" == e ? s : 3 & s | 8).toString(16) }); d.widget = new NeatComplete.Widget(e, { empty_content: "<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.", max_results: d.options.maxItems }); var n = null; d.widget.addService("addy", function (e, s) { d.fields.country && d.fields.country.options[d.fields.country.selectedIndex].value !== d.options.nzCountryValue || t("api/search?key=" + d.key + "&session=" + i + "&expostbox=" + d.options.excludePostBox + "&max=" + d.options.maxItems + "&s=" + e, function (t) { d.widget.setOption("max_results", d.options.maxItems), n = new RegExp("(" + e.split(" ").join("|") + ")", "gi"); for (var i = new Array, a = 0; a < t.addresses.length; a++) i.push({ value: t.addresses[a].a, data: t.addresses[a] }); s(e, i) }) }, { renderer: function (e, s) { var t = d.widget.getOption("highlight_class"); return s.a.replace(n, '<span class="' + (void 0 === t ? "nc_highlight" : t) + '">$1</span>') } }), d.widget.on("result:select", function (e, s) { t("api/address/" + s.id + "?key=" + d.key + "&session=" + i, function (e) { d.fields.address && (d.fields.address.value = e.displayline), d.fields.suburb && (d.fields.suburb.value = e.suburb), d.fields.city && (d.fields.city.value = e.city), d.fields.region && (d.fields.region.value = e.region), d.fields.postcode && (d.fields.postcode.value = e.postcode), d.fields.line1 && (d.fields.line1.value = e.address1), d.fields.line2 && (d.fields.line2.value = e.address2), d.fields.line3 && (d.fields.line3.value = e.address3), d.fields.line4 && (d.fields.line4.value = e.address4), !d.fields.city && d.fields.suburb && "" === e.suburb && "" !== e.city && (d.fields.suburb.value = e.city), d.fields.address1 && d.fields.address2 && (e.address4 || 0 === e.address2.indexOf("RD ") ? (d.fields.address1.value = e.address1, d.fields.address2.value = e.address2) : (d.fields.address1.value = e.displayline, d.fields.address2.value = "")) }.bind(this)) }) } else console.warn("Input field is missing") } var addySettingsFactory = new AddyUrlSettingFactory("addycomplete"), addyInitCallback = addySettingsFactory.createCallback(); addyInitCallback && window[addyInitCallback]();