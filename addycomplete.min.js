...
function AddyUrlSettingFactory(e) { function s(e) { e = e.replace(/[\[\]]/g, "\\$&"); var s = new RegExp("[?&]" + e + "(=([^&#]*)|&|#|$)").exec(n); return s ? s[2] ? decodeURIComponent(s[2].replace(/\+/g, " ")) : "" : null } this.createOptions = function () { var e = {}; return e.ignoreKeys = [38, 40, 13], e.excludePostBox = s("excludePostBox") || !1, e.nzCountryValue = s("nzCountryValue") || "NZL", e }, this.createConfig = function () { var e = {}; return e.key = s("key"), e.key && "" != e.key || console.warn("The API key is missing"), e.maxItems = s("maxItems") || 10, e }, this.createCallback = function () { var e = s("callback"); return e && "function" == typeof window[e] ? e : null }; var n = function () { var s = document.getElementsByTagName("script"); e = e.toLowerCase(); for (var n = 0; n < s.length; n++) if (s[n].src && -1 !== s[n].src.toLowerCase().indexOf(e)) return s[n].src; return console.warn("Script source not found. Name: ", e), "" }() } function AddyComplete(e, s) { function n(e, s) { reqwest({ url: d.urlBase + e, type: "jsonp", success: function (e) { s(e) } }) } if (e) { var d = this; d.urlBase = "https://www.addy.co.nz/", d.fields = s || {}, d.options = addySettingsFactory.createOptions(), d.config = addySettingsFactory.createConfig(); var i = "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g, function (e) { var s = 16 * Math.random() | 0; return ("x" == e ? s : 3 & s | 8).toString(16) }); d.widget = new NeatComplete.Widget(e, { empty_content: "<b>Address not found.</b> Please verify the address or type it in manually.", max_results: d.config.maxItems }); var a = null; d.widget.addService("addy", function (e, s) { d.fields.country && d.fields.country.options[d.fields.country.selectedIndex].value !== d.options.nzCountryValue || n("api/search?key=" + d.config.key + "&session=" + i + "&expostbox=" + d.options.excludePostBox + "&max=" + d.config.maxItems + "&s=" + e, function (n) { a = new RegExp("(" + e.split(" ").join("|") + ")", "gi"); for (var d = new Array, i = 0; i < n.addresses.length; i++) d.push({ value: n.addresses[i].a, data: n.addresses[i] }); s(e, d) }) }, { renderer: function (e, s) { return s.a.replace(a, '<span class="nc_highlight">$1</span>') } }), d.widget.on("result:select", function (e, s) { n("api/address/" + s.id + "?key=" + d.config.key + "&session=" + i, function (e) { d.fields.address && (d.fields.address.value = e.displayline), d.fields.suburb && (d.fields.suburb.value = e.suburb), d.fields.city && (d.fields.city.value = e.city), d.fields.region && (d.fields.region.value = e.region), d.fields.postcode && (d.fields.postcode.value = e.postcode), d.fields.line1 && (d.fields.line1.value = e.address1), d.fields.line2 && (d.fields.line2.value = e.address2), d.fields.line3 && (d.fields.line3.value = e.address3), d.fields.line4 && (d.fields.line4.value = e.address4), !d.fields.city && d.fields.suburb && "" === e.suburb && "" !== e.city && (d.fields.suburb.value = e.city), d.fields.address1 && d.fields.address2 && (e.address4 || 0 === e.address2.indexOf("RD ") ? (d.fields.address1.value = e.address1, d.fields.address2.value = e.address2) : (d.fields.address1.value = e.displayline, d.fields.address2.value = "")) }.bind(this)) }) } else console.warn("Input field is missing") } var addySettingsFactory = new AddyUrlSettingFactory("addycomplete"), addyInitCallback = addySettingsFactory.createCallback(); addyInitCallback && window[addyInitCallback]();