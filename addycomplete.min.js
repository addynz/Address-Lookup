...
function AddyUrlSettingFactory(e){function s(e){e=e.replace(/[\[\]]/g,"\\$&");var s=new RegExp("[?&]"+e+"(=([^&#]*)|&|#|$)").exec(d);return s?s[2]?decodeURIComponent(s[2].replace(/\+/g," ")):"":null}this.createOptions=function(){var e={};return e.excludePostBox=s("excludePostBox")||!1,e.maxItems=s("maxItems")||10,e},this.getKey=function(){var e=s("key");return e&&""==e&&console.warn("The API key is missing"),e},this.createCallback=function(){var e=s("callback");return e&&"function"==typeof window[e]?e:null},this.getLoadCssEnabled=function(){var e=s("loadcss");return e&&"true"===e};var d=function(){var s=document.getElementsByTagName("script");e=e.toLowerCase();for(var d=0;d<s.length;d++)if(s[d].src&&-1!==s[d].src.toLowerCase().indexOf(e))return s[d].src;return console.warn("Script source not found. Name: ",e),""}()}var addySettingsFactory=new AddyUrlSettingFactory("addycomplete");function AddyComplete(e,s){if(e){var d=this;d.urlBase="https://www.addy.co.nz/",d.fields=s||{},d.options=addySettingsFactory.createOptions(),d.key=addySettingsFactory.getKey();var t="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var s=16*Math.random()|0;return("x"==e?s:3&s|8).toString(16)});d.widget=new NeatComplete.Widget(e,{empty_content:"<b>Address not found.</b> Please verify the spelling.<br />For brand new addresses, please type it in manually.",max_results:d.options.maxItems});var i=null;d.widget.addService("addy",function(e,s){if(e.length<3)return s(e,new Array),void d.widget._hideResults();n("api/search?key="+d.key+"&session="+t+"&expostbox="+d.options.excludePostBox+"&max="+d.widget.getOption("max_results")+"&s="+e,function(d){i=new RegExp("("+e.split(" ").join("|")+")","gi");var t=new Array;if(d)for(var n=0;n<d.addresses.length;n++)t.push({value:d.addresses[n].a,data:d.addresses[n]});s(e,t)})},{renderer:function(e,s){var t=d.widget.getOption("highlight_class");return s.a.replace(i,'<span class="'+(void 0===t?"nc_highlight":t)+'">$1</span>')}}),d.setOption=function(e,s){e&&"exclude_postbox"===e?d.options.excludePostBox=s:d.widget.setOption(e,s)},d.enable=function(){d.widget.enable()},d.disable=function(){d.widget.disable()},d.addressSelected=function(e){},d.widget.on("result:select",function(e,s){n("api/address/"+s.id+"?key="+d.key+"&session="+t,function(e){if(e){d.fields.address&&(d.fields.address.value=e.displayline),d.fields.suburb&&(d.fields.suburb.value=e.suburb),d.fields.city&&(d.fields.city.value=e.city),d.fields.territory&&(d.fields.territory.value=e.territory),d.fields.x&&(d.fields.x.value=e.x),d.fields.y&&(d.fields.y.value=e.y),d.fields.dpid&&(d.fields.dpid.value=e.dpid),d.fields.id&&(d.fields.id.value=e.id),d.fields.postcode&&(d.fields.postcode.value=e.postcode),d.fields.line1&&(d.fields.line1.value=e.address1),d.fields.line2&&(d.fields.line2.value=e.address2),d.fields.line3&&(d.fields.line3.value=e.address3),d.fields.line4&&(d.fields.line4.value=e.address4),!d.fields.city&&d.fields.suburb&&""===e.suburb&&""!==e.city&&(d.fields.suburb.value=e.city),d.fields.address1&&d.fields.address2?(e.address4||0===e.address2.indexOf("RD ")?(d.fields.address1.value=e.address1,d.fields.address2.value=e.address2):(d.fields.address1.value=e.displayline,d.fields.address2.value=""),!d.fields.suburb&&e.suburb&&""!==e.suburb&&(""!==d.fields.address2.value&&(d.fields.address1.value+=", "+d.fields.address2.value),d.fields.address2.value=e.suburb)):d.fields.address1&&!d.fields.address2&&(d.fields.address1.value=e.displayline);var s=d.fields.region;if(s)if(s.options){e.region=e.region.toUpperCase();var t=[e.region,e.region.replace("'",""),e.region.replace("-"," - "),e.region.replace("-"," / "),e.region.replace("-","/")];console.log(t);for(var i=0;i<s.options.length;i++)if(t.indexOf(s.options[i].text.toUpperCase())>-1||t.indexOf(s.options[i].value.toUpperCase())>-1){s.selectedIndex=i;break}}else s.value=e.region;d.addressSelected(e)}}.bind(this))}),"demo-api-key"===d.key.toLowerCase()&&d.setOption("footer_content",'<b>Demo Mode:</b> Create a free account at <a href="https://www.addy.co.nz/" class="link-active">addy.co.nz</a>')}else console.warn("Input field is missing");function n(e,s){reqwest({url:d.urlBase+e,type:"jsonp",success:function(e){s(e)},error:function(e){console.log("Request failed",e)}})}}function initAddyByCss(){var e=["","2-","3-","4-"],s="addy-";function d(e){var d=document.getElementsByClassName(s+e);return 1===d.length?d[0]:null}for(var t=0;t<e.length;t++){var i=d(e[t]+"line1");if(null!==i)new AddyComplete(i,{address1:i,address2:d(e[t]+"line2"),suburb:d(e[t]+"suburb"),city:d(e[t]+"city"),region:d(e[t]+"region"),territory:d(e[t]+"territory"),postcode:d(e[t]+"postcode"),dpid:d(e[t]+"dpid"),id:d(e[t]+"id"),x:d(e[t]+"x"),y:d(e[t]+"y")})}}function callAddyInit(){var e=addySettingsFactory.createCallback(),s=!1;if(e?(window[e](),s=!0):"function"==typeof initAddy&&(initAddy(),s=!0),s||initAddyByCss(),addySettingsFactory.getLoadCssEnabled()){var d=document.createElement("link");d.setAttribute("rel","stylesheet"),d.setAttribute("type","text/css"),d.setAttribute("href","https://addycdn.azureedge.net/neatcomplete/2.1.0/addycomplete.min.css"),document.getElementsByTagName("head")[0].appendChild(d)}}callAddyInit();